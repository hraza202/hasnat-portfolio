				...
				<section className={`${about.content} ${about.container}`}>
					<div className={about.copy}>
						...
						<BadgesBlock 
							...
							copy="With 7 years of experience in IT, I possess a strong understanding of designing and implementing effective software interfaces. My background includes extensive work with a variety of digital tools and technologies, which has honed my skills in creating and managing high-quality software products."
							list={software}
							block="software" 
...
const software = [
	...
	{ key: 'computer-mouse',name: 'PhpStorm', 			type: 'fas' },
...
const tech	= [
	...
	{ key: 'rails', 		name: 'Rails', 			type: 'devicon' },
